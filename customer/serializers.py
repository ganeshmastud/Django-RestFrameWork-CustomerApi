...
class DataSheetSerializer(serializers.ModelSerializer):
    class Meta:
        model = DataSheet
        fields = ['id','url', 'description', 'historical_Data']
...
class DocumentsSerializer(serializers.ModelSerializer):
    class Meta:
        model = Documents
        fields = ['url', 'dtype','doc_number','customers']
...
class CustomerSerializer(serializers.ModelSerializer):
    ...
    document_set= DocumentsSerializer(many=True, read_only=True)
    class Meta:
        model = Customer
        fields = ['id','url', 'name', 'address', 'data_sheet', 'professions','active','status_message',
